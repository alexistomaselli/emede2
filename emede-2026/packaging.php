    ...
    <section class="relative h-[450px] flex items-center hero-section"
        ...
        <div class="max-w-7xl mx-auto px-6 w-full flex flex-col md:flex-row justify-between items-center">
            ...
            <div
                ...
                <span class="text-white border-b border-white pb-0.5">PACKAGING</span>
            </div>
        </div>
    </section>
<?php endif; ?>
                ...
                <div>
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <span class="text-accent font-bold tracking-wider text-sm uppercase">
                            <?php echo htmlspecialchars($intro['subtitle'] ?? ''); ?>
                        </span>
                    </div>
                        ...
                        <?php else: ?>
                            <div class="flex flex-col items-center">
                                <div
                                    ...
                                    <span class=" text-slate-800 dark:text-slate-400 font-bold text-[10px] text-center
                px-2 uppercase tracking-tighter">
                                        <?php echo htmlspecialchars($item['title'] ?? ''); ?>
                                    </span>
                                </div>
                            </div>
